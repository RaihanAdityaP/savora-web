...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!agreedToTerms) {
      toast.error('Anda harus menyetujui Syarat & Ketentuan dan Kebijakan Privasi')
      return
    }
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="flex items-start gap-3 pt-2">
              <input
                ...
                className="w-5 h-5 mt-0.5 rounded border-2 border-gray-300 text-[#E76F51] focus:ring-2 focus:ring-[#E76F51]/20 cursor-pointer"
                required
              />
